...
?>
    <form action="" target="_self" method="POST">
        ...
        <div class="center-text puntaje__final  margin-top-medium margin-bottom-big">
            ...
            <input type="text" title="Puntaje obtenido" size="7" maxlength="20" class="respuesta" value=" <?php echo $punt; ?>/80 " readonly>
            <?php if ($punt >= 60) {
                ...
                echo "<a class=\"botton__de-nuevo\" href=\"prueba.php\"><button type=\"submit\" name=\"enviado\"  class=\"env\">Probar de nuevo</a>";
